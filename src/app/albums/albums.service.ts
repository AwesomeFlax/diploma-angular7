...
export class AlbumsService 
{
    ...
    NF: Artist = this.artistsService.getArtistsById(1);
    adele: Artist = this.artistsService.getArtistsById(1);
    ...
    albums: Album[] = [
        ...
        [ new Track (1, 'Outcast'), new Track (1, 'Destiny')], this.NF),
        new Album(1, "Perception", "Hip-Hop", "2015-9-15", "desc1", "https://i2.cdn.hhv.de/catalog/475x475/00565/565327.jpg", 
        [ new Track (1, 'Notepad'), new Track (1, 'Trun The Music Up') ], this.NF),
        ...
        [ new Track (1, 'Venom'), new Track (1, 'Stepping Stone') ], this.eminem),
        ...
        [ new Track (1, 'Rolling In The Deep'), new Track (1, 'Set Fire To The Rain') ], this.adele)
    ]
